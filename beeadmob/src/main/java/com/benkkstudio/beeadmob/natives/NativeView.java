package com.benkkstudio.beeadmob.natives;
...
public class NativeView extends FrameLayout {
    ...
    public String getTemplateTypeName() {
        if (templateType == R.layout.medium) {
            return MEDIUM_TEMPLATE;
        } else if (templateType == R.layout.small) {
        ...
        try {
            templateType =
                    attributes.getResourceId(
                            R.styleable.TemplateView_template_type, R.layout.medium);
        } finally {
            attributes.recycle();
        }
